...
## Step 19 cold-start behavior
The frontend now tolerates a sleeping Render free instance. On first load or first chat, it can poll `/health` while the service wakes. `WAKING UP API` is expected during this period.
